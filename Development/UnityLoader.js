...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 7981979;
      var PACKAGE_UUID = '4156ca70-a7f4-44f0-86c8-4d97b57b4fe4';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 4075448, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(4075448, 4075469, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(4075469, 4075491, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(4075491, 4079502, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(4079502, 7079382, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(7079382, 7954354, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(7954354, 7981979, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_test2.data');

    };
    Module['addRunDependency']('datafile_test2.data');
